        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-10">
          ...
          <div className="space-y-8 text-gray-700">
            <section>
              ...
              <p>
                Les présentes Conditions Générales de Vente (CGV) régissent les relations contractuelles entre Belleya
            ...
            <section>
              ...
              <p className="mb-3">
                Belleya propose plusieurs forfaits d'abonnement :
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong>Belleya Start :</strong> Outils de gestion essentiels pour professionnels indépendants</li>
                <li><strong>Belleya Studio :</strong> Solution complète pour professionnels en développement</li>
                <li><strong>Belleya Empire :</strong> Suite premium avec fonctionnalités avancées et automatisation</li>
              </ul>
              <p className="mt-3">
            ...
            <section>
              ...
              <div className="space-y-3">
                ...
                <p>
                  <strong>4.3 Suspension :</strong> Belleya se réserve le droit de suspendre ou résilier un compte en cas
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Respecter les droits de propriété intellectuelle de Belleya</li>
            ...
            <section>
              <h2 className="text-2xl font-bold text-belleya-deep mb-4">
                6. Obligations de Belleya
              </h2>
              <p className="mb-3">Belleya s'engage à :</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              ...
              <p>
                Belleya traite les données personnelles conformément au RGPD. Les données collectées sont utilisées
            ...
            <section>
              ...
              <p>
                Tous les éléments du service Belleya (logiciel, design, contenus) sont protégés par le droit d'auteur et
                restent la propriété exclusive de Belleya. Le Client bénéficie d'un droit d'utilisation non exclusif et
            ...
            <section>
              ...
              <div className="space-y-3">
                <p>
                  <strong>9.1 Disponibilité :</strong> Belleya s'efforce d'assurer une disponibilité maximale du service,
                  mais ne peut garantir une disponibilité de 100%. Des interruptions pour maintenance sont possibles.
                </p>
                <p>
                  <strong>9.2 Données :</strong> Belleya met en œuvre des sauvegardes régulières mais recommande au Client
                  d'exporter régulièrement ses données importantes.
                </p>
                <p>
                  <strong>9.3 Limitation :</strong> La responsabilité de Belleya est limitée aux dommages directs et ne
            ...
            <section>
              ...
              <p>
                Belleya se réserve le droit de modifier les présentes CGV à tout moment. Les Clients seront informés des
            ...
            <section>
              ...
              <ul className="list-none space-y-2 ml-4">
                <li><strong>Email :</strong> contact@belleya.fr</li>
                <li><strong>WhatsApp :</strong> <a href="https://chat.whatsapp.com/FkLVwP6EDMNCOO4PkASezY?mode=gi_t" target="_blank" rel="noopener noreferrer" className="text-belleya-primary hover:underline">Rejoindre notre groupe</a></li>
              </ul>
            </section>
          </div>
          ...
          <div className="mt-10 pt-6 border-t border-gray-200">
            <p className="text-center text-gray-600">
              En utilisant les services Belleya, vous acceptez les présentes Conditions Générales de Vente.
            </p>
          </div>
        </div>
      </div>
