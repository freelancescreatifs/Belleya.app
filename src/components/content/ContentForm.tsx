  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const dataToSave = {
        ...
        date_script_time: formData.date_script_time?.trim() || null,
        date_script_end_time: formData.date_script_end_time?.trim() || null,
        date_shooting: formData.date_shooting?.trim() || null,
        date_shooting_time: formData.date_shooting_time?.trim() || null,
        date_shooting_end_time: formData.date_shooting_end_time?.trim() || null,
        date_editing: formData.date_editing?.trim() || null,
        date_editing_time: formData.date_editing_time?.trim() || null,
        date_editing_end_time: formData.date_editing_end_time?.trim() || null,
        date_scheduling: formData.date_scheduling?.trim() || null,
        date_scheduling_time: formData.date_scheduling_time?.trim() || null,
        date_scheduling_end_time: formData.date_scheduling_end_time?.trim() || null,
