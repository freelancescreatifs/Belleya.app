...
import { ChevronLeft, ChevronRight, FileText, Video, Scissors, Files as Subtitles, CheckCircle, Send, Filter, Calendar as CalendarIcon } from 'lucide-react';
...
const STAGE_CONFIG = {
  ...
  validation: { label: 'Validation', icon: CheckCircle, color: 'bg-green-100 text-green-700 border-belaya-300' },
