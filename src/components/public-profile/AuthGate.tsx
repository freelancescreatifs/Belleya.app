  ...
  return (
    <div className="bg-white rounded-xl max-w-md w-full">
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-4">
        ...
        {success && (
          <div className="p-3 bg-green-50 border border-belleya-200 rounded-lg flex items-start gap-2">
            <Check className="w-5 h-5 text-belleya-bright flex-shrink-0 mt-0.5" />
