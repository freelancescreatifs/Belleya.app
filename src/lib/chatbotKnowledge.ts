...
export const knowledgeBase: KnowledgeTopic[] = [
  ...
  {
    id: 'mobile-app',
    title: 'Utiliser Belaya.app sur mobile',
    keywords: ['mobile', 'telephone', 'smartphone', 'app', 'application', 'installer'],
    intent: 'use_mobile_app',
    summary: 'Belaya.app fonctionne parfaitement sur mobile et peut s\'installer comme une app.',
    steps: [
      'Ouvrez Belaya.app dans votre navigateur mobile (Safari ou Chrome)',
      'Sur iOS (Safari) :',
      '  - Appuyez sur le bouton "Partager" (carre avec fleche)',
      '  - Descendez et appuyez sur "Sur l\'ecran d\'accueil"',
      '  - Nommez l\'app "Belaya.app" et appuyez sur "Ajouter"',
      'Sur Android (Chrome) :',
      '  - Appuyez sur le menu (3 points) en haut a droite',
      '  - Selectionnez "Ajouter a l\'ecran d\'accueil"',
      '  - Confirmez en appuyant sur "Ajouter"',
      'L\'icone Belaya.app apparait sur votre ecran d\'accueil',
